...
export default function Topbar() {
  return (
      <Box p={5} fontSize={"14px"} fontWeight={"medium"} bg={"transparent"} color={spotGrey}  h={"fit-content"} w={"100%"} display={"flex"} justifyContent={"space-around"} alignItems={"center"}>
          <Box display={"flex"} gap={3} pl={3}>
          ...
          <Box w={"20%"} display={"flex"} bg={"transparent"} gap={2} justifyContent={"center"} alignItems={"center"}>
